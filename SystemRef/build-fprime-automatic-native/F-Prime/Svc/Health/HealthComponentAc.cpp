...
namespace Svc {
  ...
  {
    FW_ASSERT(portNum < this->getNum_PingReturn_InputPorts(),static_cast<FwAssertArgType>(portNum));
  ...
  {
    FW_ASSERT(portNum < this->getNum_PingSend_OutputPorts(),static_cast<FwAssertArgType>(portNum));
  ...
  {
    FW_ASSERT(portNum < this->getNum_WdogStroke_OutputPorts(),static_cast<FwAssertArgType>(portNum));
