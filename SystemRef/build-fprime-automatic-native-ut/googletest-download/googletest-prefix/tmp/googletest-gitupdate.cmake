...
execute_process(
  COMMAND "/usr/bin/git" show-ref "a3460d1"
  WORKING_DIRECTORY "/home/ethan/jpl/projects/BareMetal/fprime/gtest/googletest-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/ethan/jpl/projects/BareMetal/fprime/gtest/googletest-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/ethan/jpl/projects/BareMetal/fprime/gtest/googletest-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
