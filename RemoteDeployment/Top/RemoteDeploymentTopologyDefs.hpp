...
namespace r_eventLogger {
enum { WARN = 3, FATAL = 5 };
}
namespace r_fileDownlink {
enum { WARN = 3, FATAL = 5 };
}
namespace r_fileManager {
enum { WARN = 3, FATAL = 5 };
}
namespace r_fileUplink {
enum { WARN = 3, FATAL = 5 };
}
namespace r_prmDb {
enum { WARN = 3, FATAL = 5 };
}
namespace r_rateGroup1 {
enum { WARN = 3, FATAL = 5 };
}
namespace r_rateGroup2 {
enum { WARN = 3, FATAL = 5 };
}
namespace r_rateGroup3 {
enum { WARN = 3, FATAL = 5 };
}
}  // namespace PingEntries
}  // namespace RemoteDeployment
