// ======================================================================
// \title  RadioPassthroughTopology.hpp
// \brief header file containing the topology instantiation definitions
//
// ======================================================================
#ifndef RadioPassthrough_RadioPassthroughTOPOLOGY_HPP
#define RadioPassthrough_RadioPassthroughTOPOLOGY_HPP
// Included for access to RadioPassthrough::TopologyState and RadioPassthrough::ConfigObjects::pingEntries. These definitions are required by the
// autocoder, but are also used in this hand-coded topology.
#include <RadioPassthrough/Top/RadioPassthroughTopologyDefs.hpp>

// Remove unnecessary RadioPassthrough:: qualifications
 ...
 * RadioPassthrough::TopologyState see: RadioPassthroughTopologyDefs.hpp.
 *
 ...
 *
 * For an explanation of the required type RadioPassthrough::TopologyState see: RadioPassthroughTopologyDefs.hpp.
 *
